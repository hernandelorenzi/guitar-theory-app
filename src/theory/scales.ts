...
export interface ScaleDef {
  ...
  name: string
  formula: Formula
  group: 'diatonic' | 'pentatonic' | 'modes'
}
...
export const SCALE_GROUPS: { label: string; group: ScaleDef['group'] }[] = [
  { label: 'Diatonic',         group: 'diatonic' },
  { label: 'Pentatonic/Blues', group: 'pentatonic' },
  { label: 'Modes',            group: 'modes' },
]

export function getScalesByGroup(group: ScaleDef['group']): ScaleDef[] {
